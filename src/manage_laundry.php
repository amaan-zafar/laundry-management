				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<select name="status" id="" class="custom-select browser-default">
							<option value="0" <?php echo $status == 0 ? "selected" : '' ?>>In Queue</option>
							<option value="1" <?php echo $status == 1 ? "selected" : '' ?>>Washing</option>
							<option value="2" <?php echo $status == 2 ? "selected" : '' ?>>Washed</option>
...
<script>
	...
	// To calculate total amount for a laundry
