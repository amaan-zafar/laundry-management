				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								...
								<input type="number" class="form-control text-right" min="1" step="any" name="max_capacity">
							</div>
							...
							<tbody>
								...
								<tr>
									<td class="">
										...
										<p>Max Capacity : <b><?php echo number_format($row['max_capacity'],2) ?></b></p>
										<p>Available Capacity : <b><?php echo number_format($row['available_capacity'],2) ?></b></p>
									</td>
									<td class="text-center">
										<button class="btn btn-sm btn-info edit_cat" type="button" data-id="<?php echo $row['id'] ?>" data-name="<?php echo $row['name'] ?>" data-price="<?php echo $row['price'] ?>" >Edit</button>
